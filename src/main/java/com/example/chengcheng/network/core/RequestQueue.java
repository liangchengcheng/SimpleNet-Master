...
import com.example.chengcheng.network.httpstacks.HttpStackFactory;
 ...
 * Date:    2015年12月5日21:54:53
 * Description: 请求队列, 使用优先队列,使得请求可以按照优先级进行处理. [ Thread Safe ]
 */
public final class RequestQueue {
    ...
    public void addRequest(Request<?> request) {
        if (!mRequestQueue.contains(request)) {
            request.setmSerialNumber(this.generateSerialNumber());
